...
function AudienceNetworking({ onCardClick }) {
  const audienceItems = galleryItems.filter((item) => item.sectionId === 'audience')

  return (
    <section id="audience" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 lg:py-28 scroll-mt-32">
      {/* Minimal Header */}
      <div className="mb-12 flex items-baseline justify-between gallery-section-divider border-b pb-6">
        <h2 className="font-display text-3xl sm:text-5xl font-extrabold tracking-tight gallery-section-heading">
          <span className="text-(--color-brand-red) mr-4 font-mono text-2xl sm:text-4xl">07</span>
...
export default AudienceNetworking
