...
function LeadershipMoments({ onCardClick }) {
  const leadershipItems = galleryItems.filter((item) => item.sectionId === 'leadership')
...
export default LeadershipMoments
